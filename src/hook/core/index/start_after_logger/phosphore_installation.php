...
try
{
	...
	if (!\is_file($GLOBALS['config']['mod']['phosphore_installation']['path']['installed_file'])) // not already installed
	{
					...
					try
					{
						...
						try
						{
							...
							try
							{
								...
								$installed_file = \fopen($GLOBALS['config']['mod']['phosphore_installation']['path']['installed_file'], 'w'); // mark system as installed for this module
								\fwrite($installed_file, '1');
