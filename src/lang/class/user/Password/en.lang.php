...
/** [check] **/
/* hashed password is defined */
$GLOBALS['lang']['class']['user']['Password']['check']['loading_hashed'] = 'hashed password defined';
...
$GLOBALS['lang']['class']['user']['Password']['check']['need_rehash'] = 'hashed password needs to be rehashed';
/* password missmatch */
$GLOBALS['lang']['class']['user']['Password']['check']['bad_credential'] = 'bad credential, password missmatch';
/** [/check] **/
