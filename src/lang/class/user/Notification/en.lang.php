...
/** [delete] **/
/* missing attributes */
$GLOBALS['lang']['class']['user']['Notification']['delete']['missing_attributes'] = 'cannot delete the notification without correct attributes';
...
$GLOBALS['lang']['class']['user']['Notification']['getNotifications']['in_db'] = 'there is {number} notification(s) in the database';
/** [/getNotifications] **/
