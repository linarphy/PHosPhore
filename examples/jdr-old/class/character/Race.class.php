 ...
 * @author gugus2000
 **/
class Race extends \core\Managed
{
	/* attribute */
		...
		*/
		protected $id;
		/**
		* Id of the name of the race
		* 
		* @var string
		*/
		protected $id_name;
		/**
		* Id of the attributes of the race
		* 
		* @var int
		*/
	...
	/* method */
		...
		/* setter */
			...
			* id_name setter
			*
			* @param string id_name Id of the name of the race
			* 
			* @return void
			*/
			...
			*
			* @param int id_attributes Id of the attributes of the race
			* 
			* @return void
			*/
...
} // END class Race extends \core\Managed
